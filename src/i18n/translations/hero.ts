...
const translations = {
    en: {
        'hero.hi': "Hi, I'm",
        'hero.description': 'Fullstack freelance developer using the latest technologies.',
    ...
    fr: {
        ...
        'hero.description': 'Développeur Freelance Fullstack utilisant les dernières technologies.',
